...
const theme = createTheme({
  ...
  typography: {
    ...
    h1: { fontFamily: '"Space Mono", monospace', fontWeight: 900 },
    h2: { fontFamily: '"Space Mono", monospace', fontWeight: 900 },
    ...
    button: { fontFamily: '"Inter", "Helvetica", "Arial", sans-serif', fontWeight: 600 },
  },
  components: {
    MuiCard: {
      styleOverrides: {
    ...
    MuiButton: {
      styleOverrides: {
        root: { borderRadius: 0, textTransform: 'none', fontWeight: 600 },
        contained: {
    ...
    MuiPaper: {
      styleOverrides: {
        ...
        elevation1: { filter: 'drop-shadow(10px 5px 3px rgba(255, 255, 255, 0.3))' },
        elevation2: { filter: 'drop-shadow(12px 7px 4px rgba(255, 255, 255, 0.3))' },
        elevation3: { filter: 'drop-shadow(15px 10px 5px rgba(255, 255, 255, 0.3))' },
        elevation4: { filter: 'drop-shadow(17px 12px 6px rgba(255, 255, 255, 0.3))' },
      },
    },
    MuiChip: {
      styleOverrides: {
        root: { borderRadius: 0, filter: 'drop-shadow(5px 3px 2px rgba(255, 255, 255, 0.2))' },
      },
    },
    MuiTypography: {
      styleOverrides: {
